  ...
  const RecruitmentPage = () => {
    ...
    const jobs = [
      ...
      },
      {
        ...
        tagColor: '#E53E3E',
        deadline: '채용 시 마감',
        tasks: ['차세대 방화벽(UTM) 설계 및 구축', 'VPN / IPS / DDoS 보안 솔루션 구현', '고객사 보안 컨설팅 및 취약점 분석', '보안 장비 유지보수 및 기술지원'],
        requirements: ['방화벽, VPN 등 보안 장비 실무 경험', 'CISSP / 정보보안기사 우대', '리눅스 기반 환경 운용 가능자', '고객 커뮤니케이션 능력 보유자'],
      },
      {
        id: 3,
        title: 'IT 인프라 영업',
        ...
        tagColor: '#38A169',
        deadline: '채용 시 마감',
        tasks: ['네트워크 / 보안 솔루션 영업 및 제안', '신규 고객 발굴 및 기존 고객 관계 관리', '기술팀 협업을 통한 제안서 작성', 'Cisco·Juniper 장비 견적 및 수주 관리'],
        requirements: ['IT 솔루션 영업 경험 우대', '고객 니즈 파악 및 제안 능력 보유자', '책임감 있고 목표 지향적인 분', '운전면허 보유자 우대 (외근 업무)'],
      },
      {
        id: 4,
        title: '기술지원 엔지니어',
        ...
        tagColor: '#805AD5',
        deadline: '채용 시 마감',
        tasks: ['고객사 네트워크 장애 1차 기술지원', '원격 및 현장 유지보수 서비스', '모니터링 시스템 운영 및 알림 대응', '기술 보고서 작성 및 이력 관리'],
        requirements: ['네트워크 기초 지식 보유자 (전공 무관)', '고객 응대 능력 및 성실한 태도', '야간·주말 비상 대응 가능자', '관련 자격증 소지자 우대'],
      },
    ];

    const benefits = [
      { icon: '🏥', title: '4대 보험', desc: '국민·건강·고용·산재보험 전액 지원' },
      { icon: '📚', title: '교육비 지원', desc: '자격증 취득 및 외부 교육비 100% 지원' },
      { icon: '🎂', title: '생일·명절 선물', desc: '임직원 생일 축하금 및 명절 선물 지급' },
      { icon: '🏖️', title: '연차·휴가', desc: '법정 연차 외 창립기념일 전사 휴무' },
      { icon: '🍱', title: '중식 제공', desc: '평일 점심 식비 지원' },
      { icon: '📈', title: '성과 인센티브', desc: '반기별 실적 평가 기반 성과급 지급' },
    ];

    const steps = ['서류 접수', '1차 면접', '2차 면접 (임원)', '최종 합격', '입사'];
