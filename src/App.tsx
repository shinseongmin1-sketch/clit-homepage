...
function App() {
  ...
  const HistoryPage = () => {
    const history = [
      ...
      { year: '2022', events: [
          { date: '2022', text: '한서병원 백본스위치 구축' },
          { date: '2022', text: '양산시청 VMWARE 납품 및 설치 사업' },
          { date: '2022', text: '상수도사업본부 명장정수사업소 보안유지보수' },
          { date: '2022', text: '부산경상대학 백본스위치 신규 구축사업' },
          { date: '2022', text: '인제대학교 HP 서버 및 스토리지 납품' },
          { date: '2022', text: '현대미포조선 전산실 제반장비 설치 사업' },
          { date: '2022', text: 'EMS 통합관제 구축 사업' },
          { date: '2022', text: '창녕군청 가상화 소프트웨어 납품 및 설치' },
        ] },
      { year: '2023', events: [
          { date: '2023', text: '대동대학교 무선랜 구축 사업' },
          { date: '2023', text: '군포시 BIS 네트워크 스위치 납품 사업' },
          { date: '2023', text: '메리놀병원 무선랜 납품 및 설치 사업' },
          { date: '2023', text: '고성군 유동인구 분석시스템 구축 사업' },
          { date: '2023', text: '인제대학교 비교과통합지원시스템 스토리지 구축' },
          { date: '2023', text: '하동군청 가상화 소프트웨어 납품 및 설치' },
          { date: '2023', text: '영도병원 네트워크 구축 사업' },
          { date: '2023', text: '해군작전사령부 라우터 교체 사업' },
        ] },
      { year: '2024', events: [
          { date: '2024', text: '영도병원 네트워크 스위치 추가 사업' },
          { date: '2024', text: '경상대학교 경상관 무선랜 구축 사업' },
          { date: '2024', text: '삼성SDI 무선랜 구축 기술지원 사업' },
          { date: '2024', text: '양산제일병원 네트워크 설치 사업' },
          { date: '2024', text: '게임물관리위원회 무선랜 구축 사업' },
          { date: '2024', text: '인제대학교 의학교육정보지원 NW 구축 사업' },
          { date: '2024', text: '롯데시그니엘호텔 무선랜 구축 사업' },
          { date: '2024', text: '경성대학교 가상화서버 구축 사업' },
        ] },
      { year: '2025', events: [] },
      { year: '2026', events: [] },
    ];
